...
def layer4():
    ...
    stdout.write("                                 "+Fore.LIGHTRED_EX    +" ██████ ██      ██ ██████  \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX            +"╔═════════════════════════════════════════════════════╗\n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTRED_EX+"tcp   "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTGREEN_EX+" TCP Attack                                "+Fore.LIGHTCYAN_EX+"║\n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX            +"╚═════════════════════════════════════════════════════╝\n") 
    stdout.write("\n")
##############################################################################################
def tools():
...
def title():
    ...
    stdout.write("                                 "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"             Welcome To Project Alaska  "+Fore.LIGHTGREEN_EX  +"            ║\n")
    stdout.write("                                 "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Type [help] to see the Commands    "+Fore.LIGHTGREEN_EX +"       ║\n")
    stdout.write("                                 "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"         Contact Dev - Discord alaskaowner   "+Fore.LIGHTGREEN_EX +"       ║\n")
    stdout.write("                                 "+Fore.LIGHTGREEN_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTWHITE_EX+"╔═══"+Fore.LIGHTRED_EX+"Alaska"+Fore.CYAN+"]"+Fore.LIGHTWHITE_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
